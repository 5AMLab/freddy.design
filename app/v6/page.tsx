...
/**
 * REVIEW MOCKUP — the inline-card hero (see HeroInlineV6).
 *
 * Unlinked from the site nav and noindexed. The live homepage (app/page.tsx)
 * is untouched and still runs HeroStatementV4, so all three can be compared:
 * `/` full-bleed backdrop, `/v5` bounded panel, `/v6` inline cards.
 *
 * Everything below the hero is app/page.tsx verbatim, so the candidate is
 * judged in real page context. Promoting it means swapping the hero import in
 * app/page.tsx and deleting this route.
 */
export const metadata: Metadata = {
  title: "Studio Kavea — hero v6 mockup",
  robots: { index: false, follow: false },
};

export default function HeroV6Review() {
  return (
